    ...
    pc.add(
        [
            ...
            Parameter(
                ...
                13.0,
                1 / (uM * sec),
                "volume mass-action forward A+A2 -> A3",
            ),
    ...
    rc.add(
        [
            Reaction(
                ...
                ["A"],
                ["B"],
                {"on": "gating_f", "off": "gating_r"},
                explicit_restriction_to_domain="er_mem",
            ),  # [volume_to_volume]
            Reaction(
                "A + A2 <-> A3",
                ["A", "A2"],
                ["A3"],
                {"on": "kf", "off": "kr"},
            ),  # [volume] volume mass action (2 to 1)
            Reaction(
                "B -> 0",
                ["B"],
                [],
            ...
            Reaction(
                ...
                ["A", "X"],
                ["X2"],
                {"on": "kf_AX_X2", "off": "kr_AX_X2"},
            ),  # [volume_to_surface] [surface_to_volume]
