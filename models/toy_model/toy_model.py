...
# write out to file
p.write_json(name=cwd + '/toy_model_parameters.json')
s.write_json(name=cwd + '/toy_model_species.json')
c.write_json(name=cwd + '/toy_model_compartments.json')
r.write_json(name=cwd + '/toy_model_reactions.json')
