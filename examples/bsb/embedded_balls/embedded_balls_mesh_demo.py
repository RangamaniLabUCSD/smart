...
for idx, facet in enumerate(d.entities(bmesh, surface_dim)):
    vmesh_idx = bmesh_emap_n[
        idx
    ]  # get the index of the face on vmesh corresponding to this face on bmesh
    vmesh_boundarynumber = mf32.array()[
        vmesh_idx
    ]  # get the value of the mesh function at this face
    mf22.array()[
        idx
    ] = vmesh_boundarynumber  # set the value of the boundary mesh function to be the same value
...
for idx, facet in enumerate(d.entities(bmesh, surface_dim)):
    ...
    vmesh_boundarynumber = vmf.array()[
        vmesh_idx
    ]  # get the value of the mesh function at this face
    bmf.array()[
        idx
