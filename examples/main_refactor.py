...
PD, SD, CD, RD = stubs.common.read_smodel('toy_model_2d/toy_model_2d.smodel')

# Define solvers
mps = stubs.solvers.MultiphysicsSolver('iterative')
nls = stubs.solvers.NonlinearNewtonSolver(relative_tolerance=1e-6, absolute_tolerance=1e-7,
