...
for meshfile in [
    "/Users/rabona/Documents/stubs/examples/cell2013_3d/cube_10.xml",
    "./unit_cube.xml",
]:
        ...
        for unitA in [unit.molecule / unit.um**3, unit.uM]:
            for init_A, init_B, init_C in [(10, 1000, 0), (12, 20, 1), (20, 10, 5)]:
                for diff_A, diff_B, diff_C in [(10, 0.1, 50), (5, 5, 10), (1, 10, 10)]:
                    ...
                    sbmodel = stubs.common.read_sbmodel(
                        "cell2013_3d/cell2013_3d.sbmodel",
                    )
