...
p.append('kf', 5.0, 1/((unit.molecule/unit.um**3)*unit.s), 'forward rate')
...
s.append('X', 'cytosolic', unit.molecule/unit.um**3, 1000.0, 0.1, unit.um**2/unit.s, 'cyto')
s.append('B', 'cytosolic', unit.molecule/unit.um**3, 0.0, 50, unit.um**2/unit.s, 'cyto')
...
# write out to file
stubs.common.write_sbmodel(cwd + '/cell2013_0d.sbmodel', p, s, c, r)
