...
To get an overview of the project, read the [documentation](https://rangamanilabucsd.github.io/smart). Here are some resources to help you get started with open source contributions:
